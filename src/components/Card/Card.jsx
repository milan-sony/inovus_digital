                ...
                >
                    <SwiperSlide>
                        <div className='px-3 py-3 w-[150px] h-[180px] card-bg rounded-lg'>
                            ...
                            <marquee behavior="scroll" direction="left"><p className='text-custblue text-sm font-Open-Sans font-bold text-center mb-1 capitalize'>milan milan milan milan 25</p>
                            </marquee>
                            <hr className='mb-2' />
